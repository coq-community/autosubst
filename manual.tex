...
\begin{itemize}
\item We use singleton type classes. So a type class instance is just a definition of the recursive procedure and the type class function reduces to its instance argument. This is important because 
\end{itemize}

The first important trick is to make \lst$Subst$ a singleton type class. Thus they are invoked with \lst$subst sigma s$.
